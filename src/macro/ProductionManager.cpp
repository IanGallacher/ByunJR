...
int ProductionManager::productionCapacity() {
    ...
    size_t commandCenters = m_bot.InformationManager().UnitInfo().getUnitTypeCount(PlayerArrayIndex::Self, sc2::UNIT_TYPEID::TERRAN_COMMANDCENTER)
    ...
    size_t barracks = m_bot.InformationManager().UnitInfo().getUnitTypeCount(PlayerArrayIndex::Self, sc2::UNIT_TYPEID::TERRAN_BARRACKS);
